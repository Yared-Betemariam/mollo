  ...
  return (
    <>
      <section className="py-28 relative overflow-hidden flex items-center">
        ...
        />
        <div className="size-80 radiant-mask -z-10 blur-2xl rounded-full bg-gradient-to-b from-red-800 to-blue-800 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-15" />
        <Image
          src="/cube-pattern.png"
          width={1100}
          height={400}
          alt="pattern"
          className="size-56 opacity-[5%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
        />
